...
<body background="/img/pozadina.jpg">
    <div id="k_prvi">
        ...
        <div class="kartica"><a href="pozdrav.html">Pozdrav!</a> </div>
                    <div class="kartica">
                        ...
                        <div id="footer">
                            ...
                            <h5>Kontakt mail: mail@gameweb.ba</h5>
                            </div>
                            <div id="footer2">
                            <div class="ikona"><a href="https://www.facebook.com" target="_blank"><img src="/img/Facebook-logo-blue-circle-large-transparent-png.png" alt="facebook_logo" width="20%" height="20%"></a></div>
                            <div class="ikona"><a href="https://www.instagram.com" target="_blank"><img src="/img/instagram1.png" alt="instagram_logo" width="20%" height="20%"></a></div>    
                            <div class="ikona"><a href="https://www.twitter.com" target="_blank"><img src="/img/Twitter-logo-png.png" alt="twitter_logo" width="20%" height="20%"></a></div>
                            </div>
                            </div>         
</body>